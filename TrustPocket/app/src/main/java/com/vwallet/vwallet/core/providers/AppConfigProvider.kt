package com.vwallet.vwallet.core.providers
...
class AppConfigProvider : IAppConfigProvider, ILanguageConfigProvider, IBuildConfigProvider {
    ...
    override val companyWebPageLink: String = "https://wallet.vtctoken.io"
    override val appWebPageLink: String = "https://wallet.vtctoken.io"
    ...
    override val reportEmail = "support@vtctoken.io"
