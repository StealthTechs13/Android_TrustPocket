...
import com.vwallet.vwallet.core.fiat.AmountTypeSwitchService
import com.vwallet.vwallet.core.fiat.FiatService
import com.vwallet.vwallet.entities.CurrencyValue
import com.vwallet.vwallet.modules.swap.coincard.*
import com.vwallet.vwallet.modules.swap.settings.SwapSettingsBaseFragment
import com.vwallet.vwallet.modules.swap.settings.uniswap.UniswapSettingsFragment
import com.vwallet.vwallet.modules.swap.uniswap.UniswapFragment
...
object SwapMainModule {
    ...
    object OneInchProvider : ISwapProvider {
        override val id = "trustpocket"
        override val title = "V Wallet"
        override val url = "https://trustpocket.io/"
        override val fragment: SwapBaseFragment
            get() = UniswapFragment()
        override val settingsFragment: SwapSettingsBaseFragment
            get() = UniswapSettingsFragment()
