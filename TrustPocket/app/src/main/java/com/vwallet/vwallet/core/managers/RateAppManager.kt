...
class RateAppManager(
    ...
    companion object {
        ...
        fun openPlayMarket(context: Context) {
            try {
                ...
                val appPlayStoreLink =
                    "http://play.google.com/store/apps/details?id=finance.trustpocket.trustpocket"
        ...
        private fun getPlayMarketAppIntent(): Intent {
            val uri =
                Uri.parse("market://details?id=finance.trustpocket.trustpocket")  //context.packageName
